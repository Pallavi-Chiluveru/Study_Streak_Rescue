          ...
          {navItems.map((item) => {
            ...
            return (
              <NavLink
                ...
                to={item.path}
                className={({ isActive }) =>
                  `flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${isActive
      ...
      <div className="pt-4 border-t border-slate-200 dark:border-slate-800/80 space-y-3">
        <div className="flex items-center gap-3 px-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800">
          ...
          <div className="overflow-hidden">
            ...
            <p className="text-[11px] text-slate-600 dark:text-slate-400 truncate font-mono">⚡ {user?.xp || 0} XP</p>
          </div>
        </div>
