...
const ThemeToggle = ({ className = '' }) => {
  ...
  return (
    <button
      ...
      className={`relative flex h-10 w-10 items-center justify-center rounded-xl border transition-all duration-300 backdrop-blur-md focus:outline-none focus:ring-2 focus:ring-orange-500/40 shadow-md md:h-11 md:w-11 ${isDark
