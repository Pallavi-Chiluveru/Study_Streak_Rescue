...
const ThemeToggle = ({ className = '' }) => {
  ...
  return (
    <button
      ...
      className={`relative p-2.5 rounded-xl border transition-all duration-300 backdrop-blur-md focus:outline-none focus:ring-2 focus:ring-orange-500/40 shadow-md ${
        isDark
